...
%net=newff(dx,[3,7,2],{'tansig','tansig','purelin'},'traingdx');  %梯度下降法
net=newff(pn,tn,[3,7],{'tansig','tansig','purelin'},'traingdx');  %梯度下降法
net.divideFcn = '';         %新版的消除验证集的方法
